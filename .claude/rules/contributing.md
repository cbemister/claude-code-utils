...
1. Create markdown file: `templates/prep-claude/.claude/agents/<name>.md`
2. Include YAML frontmatter: `name`, `description`, `tools`, `model`, optional `skills`
3. Write system prompt in markdown body
4. Add to relevant teams in `templates/prep-claude/teams/teams.json`
5. Update coordinator for affected teams in `teams/<team>/coordinator.md`
6. Update `templates/prep-claude/.claude/agents/README.md`
...
1. Add team entry in `templates/prep-claude/teams/teams.json`
2. Create `templates/prep-claude/teams/<team>/coordinator.md`
3. Update `templates/prep-claude/teams/README.md`
...
- Rule files in `templates/prep-claude/` use `> [CUSTOMIZE THIS FILE]` callout
